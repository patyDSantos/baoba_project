...
class ComparadorMonitoramentoPoPeriodo:
    ...
    # ------------------------------------------------------------------ #
    def plotar_ocorrencias(self, nome_arquivo: str = "grafico_geral_comparativo_periodo_atual_anterior_ocorrencias.png") -> Path:
    ...
    # ------------------------------------------------------------------ #
    def plotar_interacoes(self, nome_arquivo: str = "grafico_geral_comparativo_periodo_atual_anterior_interacoes.png") -> Path:
